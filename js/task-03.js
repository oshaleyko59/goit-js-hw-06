...
об'єктів images.  HTML містить список ul.gallery.Використовуй
масив для створення елементів <img>,вкладених в <li>.Для створення
розмітки використовуй шаблонні рядки і insertAdjacentHTML().
Усі елементи повинні додаватися в DOM за 1 операцію.
